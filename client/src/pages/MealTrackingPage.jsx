    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm text-gray-500">Meal Tracking</p>
            <h1 className="text-3xl font-bold text-gray-900">
              {userProfile?.name ? `${userProfile.name}'s meals` : 'Your meals'}
            </h1>
            <p className="text-sm text-gray-600 mt-1">Log meals and monitor macros.</p>
          </div>
          <button
            onClick={() => setShowAddMeal(true)}
            className="flex items-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 mt-3 sm:mt-0"
          >
